...
public:
    ...
    bool begin(uint32_t sampleRate, uint8_t bitsPerSample = I2S_BITS_16, uint8_t channels = I2S_STEREO);
    void end();
...
private:
    ...
    int _sdinPin;
    size_t _bufferSize;
    i2s_callback_forward_t _rxCallback;
...
bool i2s_begin(uint32_t sampleRate, uint8_t bits = I2S_BITS_16, uint8_t channels = I2S_STEREO);
void i2s_end();
